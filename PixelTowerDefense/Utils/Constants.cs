namespace PixelTowerDefense.Utils
{
    ...
    {
        public const int ENEMY_W = 1, ENEMY_H = 5;
        public const int ARENA_LEFT = 0, ARENA_RIGHT = 100;
        public const int ARENA_TOP = 0, ARENA_BOTTOM = 100;
        ...
        public const float PICKUP_RADIUS = 2.5f;
